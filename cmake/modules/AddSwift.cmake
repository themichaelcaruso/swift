...
function(_add_variant_c_compile_flags)
  ...
  elseif("${CFLAGS_SDK}" STREQUAL "VEXOS")
    swift_vexos_include("${CFLAGS_ARCH}_INCLUDE")
    foreach(path IN LISTS CFLAGS_CXX_INCLUDES ${CFLAGS_ARCH}_INCLUDE)
      list(APPEND result "${CMAKE_INCLUDE_FLAG_C}${path}")
    endforeach()
    add_definitions(-D__VEXOS__ -D_POSIX_THREADS -D__USE_UNIX98 -D_UNIX98_THREAD_MUTEX_ATTRIBUTES)
    #-D__GTHREADS -D_POSIX_THREADS -D_POSIX_READER_WRITER_LOCKS -D_GLIBCXX_HAS_GTHREADS -D__GTHREADS_CXX0X
    list(APPEND result "-pthread")
...
function(_add_variant_swift_compile_flags
  ...
  if("${sdk}" STREQUAL "VEXOS")
    swift_vexos_include(${arch}_swift_include)
    foreach(path IN LISTS ${arch}_swift_include)
      list(APPEND result "\"${CMAKE_INCLUDE_FLAG_C}${path}\"")
    endforeach()
  endif()
